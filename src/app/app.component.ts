...
export class MyApp {
  ...
  constructor(public platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen, private accountService: AccountService, private push: Push, private localNotifications: LocalNotifications, private alertCtrl: AlertController) {
    platform.ready().then(() => {
